    ...
    <nav class="navbar header-top fixed-top navbar-expand-lg ">
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav side-nav">
          ...
          <li></li>
          <li class="nav-item navprofile text-center">
            <p class="nav-link mb-1 mt-3 welcome"><?php echo ucfirst($_SESSION['user_data']['usertype']); ?></p>
           <img src="<?php echo ROOT_URL ?>assets/images/teachers/<?php echo $_SESSION['user_data']['profileimagename']; ?>" class = "navprofilepic" >
      ...
      <li class="nav-item dropdown <?php if($_GET['controller'] == 'schedules'){
            echo ' active-nav';
          } ?>">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown1">
          <a class="dropdown-item" href="<?php echo ROOT_URL?>schedules/subjectlist">Subject list</a>
           <?php if(isset($_SESSION['is_logged_in']) && $_SESSION['user_data']['usertype'] == 'admin' ): ?>
          <a class="dropdown-item" href="<?php echo ROOT_URL?>schedules/indexscheduleshs">Schedule SHS</a>
        <?php else: ?>
          <a class="dropdown-item" href="<?php echo ROOT_URL?>schedules/teacherSched/<?php if(isset($_SESSION['user_data']['trn'])){echo $_SESSION['user_data']['trn'];} ?>">Schedules</a>
        <?php endif; ?>
        </div>
