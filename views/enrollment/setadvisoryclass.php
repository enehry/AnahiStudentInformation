<div class="container">
  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <div class="-col-md-6">
        <button class="ml-3 mb-2 btn-change-sm btn btn-danger btn-delete" data-toggle="modal" data-target="#exampleModalCenter"> <i class="fa fa-trash-alt"></i> Delete Advisory</button>
      </div>
      <!-- Modal -->
  ...
  <div class="row">
    <div class="col-md-12">
	        ...
	        <div class="col-md-3 mt-md-0 mt-btn">
            <button name="btnset" value="btnset" class="btn btn-success" form="setadviser"><i class="fa fa-user-plus"></i> Set as Adviser</button>
	        </div>
          <div class="col-md-3 col-sx-0">    
          </div>
	        </div>
