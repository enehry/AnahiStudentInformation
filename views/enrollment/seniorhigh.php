<div class="container">
  <div class="row">
    <div class="col-md-6">
       <form action="<?php echo ROOT_URL;?>enrollment/seniorhigh" method="post" nanme="formshs" id="formshs">
           ...
           <table class="table table-striped table-sm">
            ...
            <?php foreach($viewmodel as $item): ?>
                  <tr>
                    ...
                    <td><a href="<?php echo ROOT_URL; ?>teachers/teacherprofile/<?php echo $item['tblstudentid'];?>"><?php echo $item['lrn']?></a></td>
